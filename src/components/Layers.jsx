...
export function Copy({ go }) {
  ...
  return <>
    ...
    <section className="copy bean-story"><span className="number">3</span><h2><span className="text-line">FROM BEAN</span><span className="text-line">TO SOMETHING</span><span className="text-line">BETTER</span></h2><p>ORBIS adapts the ritual around you—not<br />the other way around.</p><button className="pill dark" onClick={() => go(6.65)}>FOLLOW THE BEAN <span>↗</span></button></section>
